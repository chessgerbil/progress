...
@interface ViewControllerLevelThreeTwo ()
...
@property (weak, nonatomic) IBOutlet UIImageView *imageView_referent_2;
@property (weak, nonatomic) IBOutlet UIImageView *imageView_referent_3;
@property (weak, nonatomic) IBOutlet UIImageView *imageView_referent_4;
...
@implementation ViewControllerLevelThreeTwo
...
//{
//  UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Stage 3.2" message:@"Select the the sequence after the image disapper from the choices" preferredStyle:UIAlertControllerStyleAlert];
...
- (void) componentsActivate:(BOOL)status
{
  ...
  self.button_choice_0.hidden               = YES;
  self.button_choice_1.hidden               = YES;
  self.button_choice_2.hidden               = YES;
  self.button_choice_3.hidden               = YES;
  self.button_choice_4.hidden               = YES;
  self.button_choice_5.hidden               = YES;
  self.button_choice_6.hidden               = YES;
  self.button_choice_7.hidden               = YES;
  self.button_choice_8.hidden               = YES;
  self.button_choice_9.hidden               = YES;
  self.imageView_referent_0.hidden          = status;
  self.imageView_referent_1.hidden          = status;
  self.imageView_referent_2.hidden          = status;
  self.imageView_referent_3.hidden          = status;
  self.imageView_referent_4.hidden          = status;
...
- (void) initImageArrays
{
  ...
  self.lvl_referentImagePathStringSavedArr = [[NSMutableArray alloc] initWithCapacity:LVL_THREE_TWO__IMAGE_REFERENT_TOTAL_COUNT];
  self.lvl_choiceImagePathStringSavedArr   = [[NSMutableArray alloc] initWithCapacity:LVL_THREE_TWO__CHOICE_BUTTON_TOTAL_COUNT];
}
...
- (void) initCompnentsDefaults
{
  ...
  self.label_levelName.text = @"LEVEL 3.2";
...
- (void) initLvlVariables
{
  ...
  self.lvl_currMilliseconds = LVL_THREE_DEFAULT_CURR_MILLISECOND_LEFT_MS; // count down timer in milliseconds
...
{
  [self.button_choice_0 addTarget:self action:@selector(dragOut:withEvent:) forControlEvents:UIControlEventTouchUpInside];// | UIControlEventTouchDragInside];
  [self.button_choice_1 addTarget:self action:@selector(dragOut:withEvent:) forControlEvents:UIControlEventTouchUpInside];// | UIControlEventTouchDragInside];
  [self.button_choice_2 addTarget:self action:@selector(dragOut:withEvent:) forControlEvents:UIControlEventTouchUpInside];// | UIControlEventTouchDragInside];
  [self.button_choice_3 addTarget:self action:@selector(dragOut:withEvent:) forControlEvents:UIControlEventTouchUpInside];// | UIControlEventTouchDragInside];
  [self.button_choice_4 addTarget:self action:@selector(dragOut:withEvent:) forControlEvents:UIControlEventTouchUpInside];// | UIControlEventTouchDragInside];
  [self.button_choice_5 addTarget:self action:@selector(dragOut:withEvent:) forControlEvents:UIControlEventTouchUpInside];// | UIControlEventTouchDragInside];
  [self.button_choice_6 addTarget:self action:@selector(dragOut:withEvent:) forControlEvents:UIControlEventTouchUpInside];// | UIControlEventTouchDragInside];
  [self.button_choice_7 addTarget:self action:@selector(dragOut:withEvent:) forControlEvents:UIControlEventTouchUpInside];// | UIControlEventTouchDragInside];
  [self.button_choice_8 addTarget:self action:@selector(dragOut:withEvent:) forControlEvents:UIControlEventTouchUpInside];// | UIControlEventTouchDragInside];
  [self.button_choice_9 addTarget:self action:@selector(dragOut:withEvent:) forControlEvents:UIControlEventTouchUpInside];// | UIControlEventTouchDragInside];
}
...
- (void) updateRewardScore: (int) answerType
{
  ...
  {
    self.lvl_currMilliseconds -= LVL_THREE__RESPONSE_WRONG_TIMER_SUBSTRACT_MS;
...
{
  static int referTime = LVL_THREE_DEFAULT_CURR_MILLISECOND_LEFT_MS;
  
  if (self.lvl_responseMilliSeconds == 0)
  {
    referTime = LVL_THREE_DEFAULT_CURR_MILLISECOND_LEFT_MS;
  }
...
- (void) upDateRewardTimer:(int) rewardMilliSeconds
{
  ...
  {
    self.lvl_currMilliseconds += LVL_THREE__REWARD_FAST_TIMER_ADD_MS;
  ...
  {
    self.lvl_currMilliseconds += LVL_THREE__REWARD_NORMAL_TIMER_ADD_MS;
  ...
  {
    self.lvl_currMilliseconds += LVL_THREE__REWARD_SLOW_TIMER_ADD_MS;
...
{
  if (self.lvl_totalChoiceCount <= LVL_THREE_TWO__PUZZLES_PER_LEVEL_MAX)
  {
...
-(IBAction)dragOut: (id)sender withEvent: (UIEvent *) event
{
  ...
  if ([butttonStr isEqualToString:@"button_choice_0"])
  {
    if  ([self.lvl_choiceImagePathStringSavedArr[0] isEqualToString:self.lvl_referentImagePathStringSavedArr[0]]
         ...
         || [self.lvl_choiceImagePathStringSavedArr[0] isEqualToString:self.lvl_referentImagePathStringSavedArr[2]]
         || [self.lvl_choiceImagePathStringSavedArr[0] isEqualToString:self.lvl_referentImagePathStringSavedArr[3]]
         || [self.lvl_choiceImagePathStringSavedArr[0] isEqualToString:self.lvl_referentImagePathStringSavedArr[4]])
    {
  ...
  if ([butttonStr isEqualToString:@"button_choice_1"])
  {
    if  ([self.lvl_choiceImagePathStringSavedArr[1] isEqualToString:self.lvl_referentImagePathStringSavedArr[0]]
         ...
         || [self.lvl_choiceImagePathStringSavedArr[1] isEqualToString:self.lvl_referentImagePathStringSavedArr[2]]
         || [self.lvl_choiceImagePathStringSavedArr[1] isEqualToString:self.lvl_referentImagePathStringSavedArr[3]]
         || [self.lvl_choiceImagePathStringSavedArr[1] isEqualToString:self.lvl_referentImagePathStringSavedArr[4]])
    {
  ...
  if ([butttonStr isEqualToString:@"button_choice_2"])
  {
    if  ([self.lvl_choiceImagePathStringSavedArr[2] isEqualToString:self.lvl_referentImagePathStringSavedArr[0]]
         ...
         || [self.lvl_choiceImagePathStringSavedArr[2] isEqualToString:self.lvl_referentImagePathStringSavedArr[2]]
         || [self.lvl_choiceImagePathStringSavedArr[2] isEqualToString:self.lvl_referentImagePathStringSavedArr[3]]
         || [self.lvl_choiceImagePathStringSavedArr[2] isEqualToString:self.lvl_referentImagePathStringSavedArr[4]])
    {
  ...
  if ([butttonStr isEqualToString:@"button_choice_3"])
  {
    if  ([self.lvl_choiceImagePathStringSavedArr[3] isEqualToString:self.lvl_referentImagePathStringSavedArr[0]]
         ...
         || [self.lvl_choiceImagePathStringSavedArr[3] isEqualToString:self.lvl_referentImagePathStringSavedArr[2]]
         || [self.lvl_choiceImagePathStringSavedArr[3] isEqualToString:self.lvl_referentImagePathStringSavedArr[3]]
         || [self.lvl_choiceImagePathStringSavedArr[3] isEqualToString:self.lvl_referentImagePathStringSavedArr[4]])
    {
  ...
  if ([butttonStr isEqualToString:@"button_choice_4"])
  {
    if  ([self.lvl_choiceImagePathStringSavedArr[4] isEqualToString:self.lvl_referentImagePathStringSavedArr[0]]
         ...
         || [self.lvl_choiceImagePathStringSavedArr[4] isEqualToString:self.lvl_referentImagePathStringSavedArr[2]]
         || [self.lvl_choiceImagePathStringSavedArr[4] isEqualToString:self.lvl_referentImagePathStringSavedArr[3]]
         || [self.lvl_choiceImagePathStringSavedArr[4] isEqualToString:self.lvl_referentImagePathStringSavedArr[4]])
    {
  ...
  if ([butttonStr isEqualToString:@"button_choice_5"])
  {
    if  ([self.lvl_choiceImagePathStringSavedArr[5] isEqualToString:self.lvl_referentImagePathStringSavedArr[0]]
         ...
         || [self.lvl_choiceImagePathStringSavedArr[5] isEqualToString:self.lvl_referentImagePathStringSavedArr[2]]
         || [self.lvl_choiceImagePathStringSavedArr[5] isEqualToString:self.lvl_referentImagePathStringSavedArr[3]]
         || [self.lvl_choiceImagePathStringSavedArr[5] isEqualToString:self.lvl_referentImagePathStringSavedArr[4]])
    {
  ...
  if ([butttonStr isEqualToString:@"button_choice_6"])
  {
    if  ([self.lvl_choiceImagePathStringSavedArr[6] isEqualToString:self.lvl_referentImagePathStringSavedArr[0]]
         ...
         || [self.lvl_choiceImagePathStringSavedArr[6] isEqualToString:self.lvl_referentImagePathStringSavedArr[2]]
         || [self.lvl_choiceImagePathStringSavedArr[6] isEqualToString:self.lvl_referentImagePathStringSavedArr[3]]
         || [self.lvl_choiceImagePathStringSavedArr[6] isEqualToString:self.lvl_referentImagePathStringSavedArr[4]])
    {
  ...
  if ([butttonStr isEqualToString:@"button_choice_7"])
  {
    if  ([self.lvl_choiceImagePathStringSavedArr[7] isEqualToString:self.lvl_referentImagePathStringSavedArr[0]]
         ...
         || [self.lvl_choiceImagePathStringSavedArr[7] isEqualToString:self.lvl_referentImagePathStringSavedArr[2]]
         || [self.lvl_choiceImagePathStringSavedArr[7] isEqualToString:self.lvl_referentImagePathStringSavedArr[3]]
         || [self.lvl_choiceImagePathStringSavedArr[7] isEqualToString:self.lvl_referentImagePathStringSavedArr[4]])
    {
  ...
  if ([butttonStr isEqualToString:@"button_choice_8"])
  {
    if  ([self.lvl_choiceImagePathStringSavedArr[8] isEqualToString:self.lvl_referentImagePathStringSavedArr[0]]
         ...
         || [self.lvl_choiceImagePathStringSavedArr[8] isEqualToString:self.lvl_referentImagePathStringSavedArr[2]]
         || [self.lvl_choiceImagePathStringSavedArr[8] isEqualToString:self.lvl_referentImagePathStringSavedArr[3]]
         || [self.lvl_choiceImagePathStringSavedArr[8] isEqualToString:self.lvl_referentImagePathStringSavedArr[4]])
    {
  ...
  if ([butttonStr isEqualToString:@"button_choice_9"])
  {
    if  ([self.lvl_choiceImagePathStringSavedArr[9] isEqualToString:self.lvl_referentImagePathStringSavedArr[0]]
         ...
         || [self.lvl_choiceImagePathStringSavedArr[9] isEqualToString:self.lvl_referentImagePathStringSavedArr[2]]
         || [self.lvl_choiceImagePathStringSavedArr[9] isEqualToString:self.lvl_referentImagePathStringSavedArr[3]]
         || [self.lvl_choiceImagePathStringSavedArr[9] isEqualToString:self.lvl_referentImagePathStringSavedArr[4]])
    {
  ...
  if (dragCount >= LVL_THREE_TWO__IMAGE_REFERENT_TOTAL_COUNT)
  {
    dragCount = 0;
    //prevButtonStr = @"";
...
{
  for (UInt8 i = 0; i < LVL_THREE_TWO__IMAGE_REFERENT_TOTAL_COUNT; i++)
  {
    self.lvl_referentImagePathStringSavedArr[i] = [self getRandomReferentImagePathAsString];
  }
  
  for (UInt8 i = 0; i < LVL_THREE_TWO__CHOICE_BUTTON_TOTAL_COUNT; i++)
  {
    if (i < LVL_THREE_TWO__IMAGE_REFERENT_TOTAL_COUNT)
    {
  ...
  dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
    self.imageView_referent_0.image = nil;
    self.imageView_referent_1.image = nil;
    self.imageView_referent_2.image = nil;
    self.imageView_referent_3.image = nil;
    self.imageView_referent_4.image = nil;
  });
  */
  
  //DONGcode - sequential disappearing of referents - ref0 disappears at 1 sec
  dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
    self.imageView_referent_0.image = nil;
  });
  
  //DONGcode - sequential disappearing of referents - ref1 disappears 0.75s later
  dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.95 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
    self.imageView_referent_1.image = nil;
  });
  
  //DONGcode - sequential disappearing of referents - ref2 disappears 0.65s later
  dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(2.6 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
    self.imageView_referent_2.image = nil;
  });
  
  //DONGcode - sequential disappearing of referents - ref3 disappears 0.5s later
  dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(3.1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
    self.imageView_referent_3.image = nil;
  });
  
  //DONGcode - sequential disappearing of referents - ref4 disappears 0.5s later
  dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(3.6 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
    self.imageView_referent_4.image = nil;
  });
  
  //DONGcode - 0.3s first row of choice appear
  dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(3.9 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
    self.button_choice_0.hidden               = NO;
    self.button_choice_1.hidden               = NO;
    self.button_choice_2.hidden               = NO;
  });

  //DONGcode - 0.3s second row of choice appear
  dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(4.2 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
    self.button_choice_3.hidden               = NO;
    self.button_choice_4.hidden               = NO;
    self.button_choice_5.hidden               = NO;
    self.button_choice_6.hidden               = NO;
  });
  
  //DONGcode - 0.3s second row of choice appear
  dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(4.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
    self.button_choice_7.hidden               = NO;
    self.button_choice_8.hidden               = NO;
    self.button_choice_9.hidden               = NO;
  });
  ...
  self.imageView_referent_2.image = [UIImage imageNamed:[self.lvl_referentImagePathStringSavedArr objectAtIndex:2]];
  self.imageView_referent_3.image = [UIImage imageNamed:[self.lvl_referentImagePathStringSavedArr objectAtIndex:3]];
  self.imageView_referent_4.image = [UIImage imageNamed:[self.lvl_referentImagePathStringSavedArr objectAtIndex:4]];
  // update choice image 0
  UIImage *choice_0 = [UIImage imageNamed:[self.lvl_choiceImagePathStringSavedArr objectAtIndex:0]];
  [self.button_choice_0 setBackgroundImage:choice_0 forState:UIControlStateNormal];
  self.button_choice_0.hidden               = YES;
...
- (void) loadNextView
{
  [self performSegueWithIdentifier:@"segue_levelThreeTwoToLevelScoreSheet" sender:self];
...
- (void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
  if ([segue.identifier isEqualToString:@"segue_levelThreeTwoToLevelScoreSheet"])
  {
    ...
    vc.lvl_scoreSheet_levelNumberPlayed     = LVL_PLAYED__THREE_TWO;
